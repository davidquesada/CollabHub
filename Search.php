  ...
  <head>
    ...
    <script>
      ...
      function get_request()
      {
        ...
        person = document.getElementById('person-box').value.Trim().ToLower();
        tag = document.getElementById('tag-box').value.Trim().ToLower();
        location = document.getElementById('location-box').value.Trim().ToLower();
  ...
  <body >
    ...
    <?php include "common-navbar.php"; ?> 
      ...
      <div class="container" style="background-color:#E6E6E6; border-radius:6px">
		...
		<?php
		if(array_key_exists('tag', get_defined_vars()) && array_key_exists('name', get_defined_vars()) && array_key_exists('location', get_defined_vars()) && !($tag=="" && $name=="" && $location=="")){
